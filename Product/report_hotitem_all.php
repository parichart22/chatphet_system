...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">สินค้าขายดีทั้งหมด</h1>
</div>
<div class="row g-3">
  <div class="col-auto">
  ...
  <div class="col-auto">
    <a href="#" class="btn btn-primary mb-3" onclick="ReportHotitemAll()">ดูรายการ</a>
  </div>
</div>
...
<table class="table">
  ...
  <tbody>
<?php
    $result = mysqli_query($con,"SELECT sum(amount),pk_product FROM order_detail WHERE DATE(datetime) BETWEEN '".DATE('Y-m-d')."' and '".DATE('Y-m-d')."' GROUP by pk_product ORDER by sum(amount) DESC");
