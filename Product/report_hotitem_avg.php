...
<?php
  ...
  while($row=mysqli_fetch_array($result)){
    ...
    echo "<tr><th scope='row'>".$no."</th><td><a href='main.php?page=9&pk=".$row_p['pk']."' target='_blank'><img src='".$row_p['pic']."' class='img-thumbnail'></a></td><td><a href='main.php?page=2&pk=".$row_p['pk']."' target='_blank'>".$row_p['name']."</a><hr>".$row_p['company']."<hr>";
    if($row_p['mark_exp']==1){
    ...
    echo "</td><td class='text-center h4'>".$row_lock['lock_am']."</td><td class='text-center h4'>".$row_p['amount']."</td><td class='text-center h4'>".$row[0]."</td></tr>";
} ?>
  </tbody>
</table>
</div>
